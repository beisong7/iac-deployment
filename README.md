...
- Clone the repo. and make a PR from another branch into main branch to review the Terraform Plan, while making a push into main or completing any merge into main branch will deploy the application to the kubernetes cluster.

## Developer

Access keys to the developer account has been provided in a faile shared via the submission link
